...
export default function Layout({ children, activePage = 'home', onNavHover }) {
  ...
  const handleSimpleHover = (key, isHovering) => {
    ...
    // Call the parent's onNavHover function if provided
    if (onNavHover && videos[key]) {
      onNavHover(isHovering ? key : null);
    }
  };
      ...
      {!isMobile ? (
        ...
        <div className="mobile-page">
          ...
          <div className="main-content-area">
            ...
            {activePage === 'home' && (
              <img src="/images/heart.png" alt="" className="blue-heart" />
            )}
            
            {/* Main content from child component */}
            {children}
          </div>
          
          {/* Mobile navigation area */}
          <div className="mobile-nav-area">
            {/* Row 1: Tetování + Kontakt */}
            <div className="mobile-nav-row">
              <Link href="/tetovani" className="mobile-nav-item">
                tetování.
              </Link>
              <Link href="/kontakt" className="mobile-nav-item">
                kontakt.
              </Link>
            </div>
            
            {/* Row 2: Another tetování + přijímám klienty */}
            <div className="mobile-nav-row">
              <Link href="/malba" className="mobile-nav-item">
                malba.
              </Link>
              <div className="client-status">
                <img src="/images/go.png" alt="" className="client-icon" />
                mám volné termíny.
              </div>
            </div>
            
            {/* Row 3: Another tetování */}
            <div className="mobile-nav-row">
              <Link href="/ilustrace" className="mobile-nav-item">
                ilustrace.
              </Link>
            </div>
            
            {/* Row 4: Another tetování */}
            <div className="mobile-nav-row">
              <Link href="/parte" className="mobile-nav-item">
                parte.
              </Link>
              <div>
              <a 
